...
export async function readAtlasWorld(config) {
  const [cities, topics, signals] = await Promise.all([
    fetchTable(config, "atlas_cities", "id,name,country,human_activity,ai_activity,display_order", "display_order.asc"),
