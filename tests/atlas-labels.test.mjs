...
test("phase 6 renders country energy and crisp individual agents at city level", () => {
  ...
  assert.match(experienceSource, /worldUnitsPerPixel \* AGENT_MARKER_SCREEN_RADIUS_PX \/ AGENT_MARKER_GEOMETRY_RADIUS/);
  assert.match(experienceSource, /useFrame\(\(\{ camera, size \}\) => \{/);
